...
from SST.trainer import Trainer

from LAUR_model.model import LAUR_model,BertClassifier_base
from LAUR_model.model import BertConfig
...
class ModelArguments:
    ...
    old_model_path: Optional[str] = field(
        default=None, metadata={"help": "Pretrained model_path"}
    )
    
    no_regular: bool = field(
        default=False,
        metadata={"help": "BERT"},
    )
...
def main():
    ...
    if data_args.task_name is not None:
        ...
        datasets = load_dataset(
            "./SST/huggingface_csv_preprocessing.py", data_files={"train": data_args.train_file, "validation": data_args.validation_file}
        )
    else:
    ...
    if training_args.do_train:
        ...
        torch.save(trainer.model,"best_SST.pt")
